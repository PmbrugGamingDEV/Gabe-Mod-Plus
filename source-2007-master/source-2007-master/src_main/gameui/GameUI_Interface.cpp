...
void CGameUI::OnGameUIActivated()
{
	...
	{
		// Attach your panel
		vgui::ipanel()->SetParent(m_hMainMenuOverride, staticPanel->GetVPanel());
		vgui::ipanel()->SetVisible(m_hMainMenuOverride, true);
		vgui::ipanel()->MoveToFront(m_hMainMenuOverride);

		Msg("[GAMEUI] Custom main menu applied!\n"); // This is a sign that your module is doing something right, and that the main menu override is working.
	}
