...
ConVar sk_plr_dmg_xbow_bolt_plr("sk_plr_dmg_xbow_bolt_plr", "100");
ConVar sk_plr_dmg_xbow_bolt_npc("sk_plr_dmg_xbow_bolt_npc", "100");
...
class CWeaponHL1Crossbow : public CBaseHLCombatWeapon
{
	DECLARE_CLASS( CWeaponHL1Crossbow, CBaseHLCombatWeapon );
public:
...
LINK_ENTITY_TO_CLASS( weapon_hl1_crossbow, CWeaponHL1Crossbow );

PRECACHE_WEAPON_REGISTER( weapon_hl1_crossbow );
