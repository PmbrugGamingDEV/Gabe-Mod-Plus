...
// Blobulator system not available in SDK 2007
...
private:
	virtual void addParticleForce(void* a, void* b, float distSq, float flStrength, float ts) const;
};
