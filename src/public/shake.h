...
#define FFADE_IN			0x0001		// Just here so we don't pass 0 into the function // this is a fade in (not out)
#define FFADE_OUT			0x0002		// Fade out (not in) // this is a fade out (not in)
